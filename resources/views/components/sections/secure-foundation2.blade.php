<section class="relative py-2 transition-colors duration-300 bg-white dark:bg-gray-900">
    ...
    <div class="relative container mx-auto px-4 max-w-7xl">
        <div class="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div class="relative">
                <div
                    class="absolute inset-0 bg-gradient-to-br from-cyan-400/5 to-teal-400/5 dark:from-cyan-300/3 dark:to-teal-300/3 rounded-3xl blur-2xl scale-105">
                </div>

                <div class="relative flex items-center justify-center p-6">
                    <img class="w-full h-auto drop-shadow-xl transform hover:scale-105 transition-all duration-500"
                        src="{{ asset('icons/workers-nobg.png') }}" alt="Strong foundation construction" />
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold leading-tight text-gray-900 dark:text-white">
                    Secure Your Foundation with
                    <span class="relative inline-block">
                        <span
                            class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-teal-600 dark:from-cyan-400 dark:to-teal-400">Precision</span>
                        <span
                            class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-600 to-teal-600 dark:from-cyan-400 dark:to-teal-400 opacity-30"></span>
                    </span>
                </h2>
                ...
                <div class="grid gap-3 pt-2">
                    <div
                        ...
                        <svg class="w-6 h-6 text-cyan-600 dark:text-cyan-400 flex-shrink-0 mt-0.5" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <div>
                            <p class="text-sm text-gray-700 dark:text-gray-300">
                                <span class="font-bold text-cyan-600 dark:text-cyan-400">Awar Rafeh Group Companies</span>
                                blends expertise with exceptional service, built on
                                <span class="font-semibold">promptness, punctuality, and professionalism</span>.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        class="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                        <svg class="w-6 h-6 text-teal-600 dark:text-teal-400 flex-shrink-0 mt-0.5" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
