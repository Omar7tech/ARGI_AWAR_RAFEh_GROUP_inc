    ...
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="mt-8 text-center">
            ...
            <a href="tel:7572871737"
                class="inline-flex items-center justify-center gap-3 px-8 py-3 text-base font-bold text-white
                        bg-gradient-to-r from-teal-600 to-cyan-600 rounded-xl shadow-xl shadow-teal-500/30
                        hover:from-teal-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-[1.03]">
